...
MoveMouse(x, y, speed:= 0.6, randomness:= 10, RD:= ""){
    ...
    Random, rxRan,-1*randomness,randomness  ; here you can randomize your destination coordinates
    Random, ryRan,-1*randomness,randomness  ; so you don't need to randomize them in your main script
...
newArr:=[]
newArr:= WindMouse2(xpos, ypos, x, y, 10, 8, finalSpeed * 10, finalSpeed * 12, stepArea * 11, stepArea * 7)
SortArray(newArr, "D")
c:= newArr.Count()
g:= c/2
	Loop, %g%{
...
WindMouse(xpos, ypos, x, y, 10, 8, finalSpeed * 10, finalSpeed * 12, stepArea * 11, stepArea * 7, newArr)
newArr:=[]
}
goRelative(x, y, speed){
MouseGetPos, xpos, ypos
